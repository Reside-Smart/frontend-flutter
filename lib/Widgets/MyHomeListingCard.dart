// widgets/MyHomeListingCard.dart
...
class _MyHomeListingCardState extends State<MyHomeListingCard> {
  ...
  // Track favorite state & loading per‐card
  ...
  void initState() {
    super.initState();
    // Initialize from model (or fetch from API)
    _isFavorite.value = widget.listingModel.isFavorite;
    print(_isFavorite.value);
  }

  Future<void> _toggleFavorite() async {
    if (_isToggling.value) return; // ignore rapid taps
    ...
    if (success) {
      ...
      // you might show a Snackbar/error here
      Get.snackbar(
        'Error',
